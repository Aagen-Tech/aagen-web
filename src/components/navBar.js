                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <Image
                            ...
                            src="/assets/aagen-logo-full.svg"
                            alt="Aagen logo"
                            width={120}
                            height={18}
                            priority
                        />
                        {/* <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Aagen</span> */}
                    </a>
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <Link
                            href="/registration"
                            type="button" 
                            className="text-slate-900 focus:outline-none text-lg rounded-lg font-semibold hover-underline-animation px-4 py-2 text-center dark:text-white"
                        >Get started</Link>
                        <Link
                            href="/chat"
                            type="button" 
